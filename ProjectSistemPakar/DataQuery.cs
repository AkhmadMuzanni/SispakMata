...
namespace ProjectSistemPakar
{
    ...
    {
        List<CheckBox> cekBox = new List<CheckBox>();
        public void tambahCekBox(CheckBox cekBox)
        {
            this.cekBox.Add(cekBox);
        }
        public void hapusCekBox(CheckBox cekBox)
        {
            this.cekBox.Remove(cekBox);
        }
        public List<CheckBox> getCekBox()
        {
            return cekBox;
        }
        public string forwardChaining(Login parent)
        {
            ...
            } else if (cekBox.Contains(parent.gejala2.cbGejala03) &&
            ...
            if (detected)
            {
                ...
                {
                    result += cekBox.ElementAt(i).Text + ", \n";
                }
            } else
            {
